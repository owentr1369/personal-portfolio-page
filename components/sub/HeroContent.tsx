        ...
        <motion.div initial="hidden" animate="visible" className="flex flex-row items-center justify-center px-20 mt-40 w-full z-[20]">
            <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
                <motion.div variants={slideInFromTop} className="Welcome-box py-[8px] px-[14px] border border-[#7042F99B] opacity-[0.9]">
                    ...
                    <h1 className="Welcome-text text-[13px]">Thien Tam T.&apos;s Portfolio</h1>
                </motion.div>
                <motion.div
            ...
            <motion.div variants={slideInFromRight(0.8)} className="w-full h-full flex flex-center items-center">
                <Image src='/mainIconsdark.svg' alt="works icons" height={650} width={650} />
            </motion.div>
        </motion.div>
    )
}
